...
const restaurantConfig = JSON.parse(
  readFileSync(join(__dirname, 'restaurant-config.json'), 'utf-8')
);
...
export const MENU_LOOKUP: Record<string, MenuItem> = {};
...
export const ALL_ALLERGENS = Array.from(
  new Set(
    RESTAURANT_CONFIG.menu.categories.flatMap((cat) =>
